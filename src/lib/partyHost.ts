 ...
 * LAN would resolve "localhost" to itself, not the machine running `partykit dev`, and hang
 ...
 * Production should still set VITE_PARTYKIT_HOST to the deployed PartyKit host.
 */
